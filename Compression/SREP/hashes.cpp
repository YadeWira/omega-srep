...
// hash �������� �������� ���-������� �� ��������� L ������������ ����, ��� �������� ���������� ������������ ���������� ���-�������.
// constructor(buf,L,seed) ������ ���, ����������������� seed, � �������������� ��� ������� L ������� ������
// update(sub,add) ������� �� ���� ���� sub � ��������� ���� add.
...
struct VHash
{
  ...
  void compute (const void *ptr, size_t size, void *result)
  {
    ...
    // UBSAN-clean: result may not be 8-byte aligned; memcpy avoids
    // the cast UB. gcc/clang optimize this to a single mov on x86_64.
    memcpy(result, &res, sizeof(uint64_t));
    if (VMAC_TAG_LEN==128)
      memcpy((char*)result + sizeof(uint64_t), &tagl, sizeof(uint64_t));
  }
};
